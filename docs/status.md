...
| **Interface** | "Laudtee" (`DESIGN.md`): a spine layout on tablet and desktop with a context rail from 1080px, a thumb dock on the phone; Onest and Literata are self-hosted under `eesti/web/fonts/` (SIL OFL 1.1). |
